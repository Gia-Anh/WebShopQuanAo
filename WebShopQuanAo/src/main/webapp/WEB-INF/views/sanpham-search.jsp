                                  ...
                                  <div class="row">
                                       <div class="col-lg-6 col-md-9 col-sm-9 col-xs-12">
			                              	...
			                              	<c:if test="${not empty keyname}">
			                              		<c:url var="sortUrl" value="sort?type=${type}&key=${key}&page=${page}" />
			                              	</c:if>
                                      		<form action="${sortUrl}">
                                ...
                                <div class="pagination-btn text-center">
                                    <ul class="page-numbers">
                                    	<c:if test="${page==1}">
	                                    	...
	                                    	<c:if test="${totalPage!=1 && totalPage!=0}">
		                                       	<li><span class="page-numbers current">1</span></li>
		                                        <li><a href="search?key=${keyname}&page=2" class="page-numbers">2</a></li>
		                                        <li><a class="page-numbers">...</a></li>
		                                        <li><a href="search?key=${keyname}&page=${totalPage}" class="page-numbers">${totalPage}</a></li>
		                                        <li><a href="search?key=${keyname}&page=${totalPage}" class="next page-numbers">&#8608;</i></a></li>
	                                    	</c:if>
                                    	</c:if>
                                    	<c:if test="${page!=1 && page!=totalPage}">
                                    		<li><a href="search?key=${keyname}&page=1" class="next page-numbers">&#8606;</a></li>
                                    		<li><a href="search?key=${keyname}&page=${page-1}" class="page-numbers">${page-1}</a></li>
                                       	...
                                       	<c:if test="${page==totalPage}">
                                       		<c:if test="${page!=1}">
		                                        <li><a href="search?key=${keyname}&page=1" class="next page-numbers">&#8606;</a></li>
		                                        <li><a href="search?key=${keyname}&page=1" class="page-numbers">1</a></li>
		                                        <li><a class="page-numbers">...</a></li>
		                                        <li><a href="search?key=${keyname}&page=${totalPage-1}" class="page-numbers">${totalPage-1}</a></li>
