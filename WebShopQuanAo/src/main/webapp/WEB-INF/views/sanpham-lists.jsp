                                    ...
                                    <div id="cat-treeview" class="product-cat">
                                        <ul>
                                            <li class="closed"><a href="#">Áo (04)</a>
                                                <ul>
                                                    <li><a href="list?category=1&page=1">Áo thun nam</a></li>
                                                    <li><a href="list?category=2&page=1">Áo sơ mi nam</a></li>
                                                    <li><a href="list?category=7&page=1">Áo thun nữ</a></li>
                                                    <li><a href="list?category=8&page=1">Áo sơ mi nữ</a></li>
                                                </ul>
                                             </li>
                                            <li class="closed"><a href="#">Quần (07)</a>
                                                <ul>
                                                    <li><a href="list?category=3&page=1">Quần jean nam</a></li>
                                                    <li><a href="list?category=4&page=1">Quần tây</a></li>
                                                    <li><a href="list?category=5&page=1">Quần short nam</a></li>
                                                    <li><a href="list?category=9&page=1">Quần short nữ</a></li>
                                                    <li><a href="list?category=10&page=1">Quần jean nữ</a></li>
                                                    <li><a href="list?category=11&page=1">Quần jogger</a></li>
                                                    <li><a href="list?category=12&page=1">Chân váy</a></li>
                                                </ul>
                                            </li>
                                            <li class="closed"><a href="#">Áo khoác (02)</a>
                                                <ul>
                                                    <li><a href="list?category=6&page=1">Áo khoác nam</a></li>
                                                    <li><a href="list?category=13&page=1">Áo khoác nữ</a></li>
                                                </ul>
                                            </li>
                                            <li class="closed"><a href="#">Phụ kiện (06)</a>
                                                <ul>
                                                    <li><a href="list?category=14&page=1">Ba lô</a></li>
                                                    <li><a href="list?category=15&page=1">Túi xách</a></li>
                                                    <li><a href="list?category=16&page=1">Nón phớt</a></li>
                                                    <li><a href="list?category=17&page=1">Nón lưỡi trai</a></li>
                                                    <li><a href="list?category=18&page=1">Nón bucket</a></li>
                                                    <li><a href="list?category=19&page=1">Ví</a></li>
                                                </ul>
                                            </li>
                                        </ul>
                                    </div>
                                ...
                                <div class="pagination-btn text-center">
                                    <ul class="page-numbers">
                                    	<c:if test="${page==1}">
	                                    	...
	                                    	<c:if test="${totalPage!=1 && totalPage!=0}">
		                                        <li><span class="page-numbers current">1</span></li>
		                                        <li><a href="list?category=${category}&page=2" class="page-numbers">2</a></li>
		                                        <li><a class="page-numbers">...</a></li>
		                                        <li><a href="list?category=${category}&page=${totalPage}" class="page-numbers">${totalPage}</a></li>
		                                        <li><a href="list?category=${category}&page=${totalPage}" class="next page-numbers">&#8608;</i></a></li>
	                                    	</c:if>
                                    	</c:if>
                                    	<c:if test="${page!=1 && page!=totalPage}">
                                    		<li><a href="list?category=${category}&page=1" class="next page-numbers">&#8606;</a></li>
                                    		<li><a href="list?category=${category}&page=${page-1}" class="page-numbers">${page-1}</a></li>
                                       	...
                                       	<c:if test="${page==totalPage}">
	                                    	<c:if test="${page!=1}">
		                                        <li><a href="list?category=${category}&page=1" class="next page-numbers">&#8606;</a></li>
		                                        <li><a href="list?category=${category}&page=1" class="page-numbers">1</a></li>
		                                        <li><a class="page-numbers">...</a></li>
		                                        <li><a href="list?category=${category}&page=${totalPage-1}" class="page-numbers">${totalPage-1}</a></li>
